<html><head>
    ...
    <meta name="title" content="ibootstrap - Bootstrap可视化布局系统">
    <meta name="description" content="ibootstrap 可拖放排序在线编辑的Bootstrap可视化布局系统">
    <meta name="keywords" content="可视化,布局,系统">
    <title>Bootstrap可视化布局系统</title>

    <!-- Le styles -->
    <link href="http://cdn.ibootstrap.cn/v2/css/bootstrap-combined.min.css" rel="stylesheet">
    <link href="http://cdn.ibootstrap.cn/v2/css/layoutit.css" rel="stylesheet">
    ...
    <!-- Fav and touch icons -->
    <link rel="shortcut icon" href="http://cdn.ibootstrap.cn/v2/img/favicon.png">

    <script src="//hm.baidu.com/hm.js?5d1095a7e8dafabe802aa295af4d0ce2"></script><script type="text/javascript" src="http://cdn.ibootstrap.cn/v2/js/jquery-2.0.0.min.js"></script>
    <!--[if lt IE 9]>
    <script type="text/javascript" src="http://cdn.staticfile.org/jquery/1.9.1/jquery.min.js"></script>
    <![endif]-->
    <script type="text/javascript" src="http://cdn.ibootstrap.cn/v2/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="http://cdn.ibootstrap.cn/v2/js/jquery-ui.js"></script>
    <script type="text/javascript" src="http://cdn.ibootstrap.cn/v2/js/jquery.ui.touch-punch.min.js"></script>
    <script type="text/javascript" src="http://cdn.ibootstrap.cn/v2/js/jquery.htmlClean.js"></script>
    <script type="text/javascript" src="http://cdn.ibootstrap.cn/v2/ckeditor/ckeditor.js"></script><style>.cke{visibility:hidden;}</style>
    <script type="text/javascript" src="http://cdn.ibootstrap.cn/v2/ckeditor/config.js"></script>
    <script type="text/javascript" src="http://cdn.ibootstrap.cn/v2/js/scripts.js"></script>
    ...
    <script type="text/javascript" src="http://cdn.ibootstrap.cn/v2/ckeditor/config.js?t=D3NA"></script><link rel="stylesheet" type="text/css" href="http://cdn.ibootstrap.cn/v2/ckeditor/skins/moono/editor.css?t=D3NA"><script type="text/javascript" src="http://cdn.ibootstrap.cn/v2/ckeditor/lang/zh-cn.js?t=D3NA"></script><script type="text/javascript" src="http://cdn.ibootstrap.cn/v2/ckeditor/styles.js?t=D3NA"></script></head>

<body style="min-height: 471px; cursor: auto;" class="devpreview sourcepreview">
...
<div class="container-fluid">
    <div class="row-fluid">
            ...
            <div class="sidebar-nav">
                <ul class="nav nav-list accordion-group">
                  ...
                  拖动
                            ...
                            <div class="preview">
                                <input value="4 4 4" type="text"></div>
                            <div class="view">
                                <div class="row-fluid clearfix">
                                    <div class="span4 column"></div>
                                    <div class="span4 column"></div>
                  ...
                  拖动
                            ...
                            <div class="preview">
                                <input value="2 6 4" type="text"></div>
                            <div class="view">
                                <div class="row-fluid clearfix">
                ...
                <ul class="nav nav-list accordion-group">
                    <li class="nav-header">
                        ...
                        <div class="pull-right popover-info">
                            ...
                            <div class="popover fade right">
                                ...
                                <div class="popover-content">
                                    这里提供了一系列基本元素样式，你可以通过区块右上角的编辑按钮修改样式设置。如需了解更多信息，请访问
                  ...
                  <a class="btn btn-mini" href="#" rel="lead">Lead</a>
                            ...
                            <div class="view" contenteditable="true">
                                <p> <em>Git</em>
                                    是一个分布式的版本控制系统，最初由 <b>Linus Torvalds</b>
                                    编写，用作Linux内核代码的管理。在推出后，Git在其它项目中也取得了很大成功，尤其是在Ruby社区中。
                                </p>
                            </div>
                        </div>
                        <div class="box box-element ui-draggable">
                            ...
                            <div class="view">
                                <form class="form-horizontal">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input id="inputEmail" placeholder="Email" type="text"></div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="inputPassword" contenteditable="true">密码</label>
                                        <div class="controls">
                                            <input id="inputPassword" placeholder="Password" type="password"></div>
                                    </div>
                                    <div class="control-group">
                                        <div class="controls">
                                            <label class="checkbox" contenteditable="true">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="">
                        <a href="#" rel="img-polaroid">相框</a>
                            ...
                            <div class="view">
                                <img alt="140x140" src="http://cdn.ibootstrap.cn/img/a.jpg"></div>
                        </div>
                    </li>
                </ul>
                <ul class="nav nav-list accordion-group">
                    <li class="nav-header">
                        ...
                        <div class="pull-right popover-info">
                            ...
                            <div class="popover fade right">
                                ...
                                <h3 class="popover-title">帮助</h3>
                                <div class="popover-content">
                                    拖放组件到布局框内. 拖入后你可以设置组件样式. 查看这里获取更多帮助
                  ...
                  <button type="button" class="btn btn-mini" data-target="#editorModal" role="button" data-toggle="modal">编辑</button>
                            ...
                            <div class="view">
                                <ul class="thumbnails">
                                    <li class="span4">
                                        <div class="thumbnail">
                                            <img alt="300x200" src="http://cdn.ibootstrap.cn/img/people.jpg">
                                    ...
                                    <li class="span4">
                                        <div class="thumbnail">
                                            <img alt="300x200" src="http://cdn.ibootstrap.cn/img/city.jpg">
                                            <div class="caption" contenteditable="true">
                                                <h3>哈佛结构</h3>
                                    ...
                                    <li class="span4">
                                        <div class="thumbnail">
                                            <img alt="300x200" src="http://cdn.ibootstrap.cn/img/sports.jpg">
                                            <div class="caption" contenteditable="true">
                                                <h3>改进型哈佛结构</h3>
                            ...
                            <div class="view">
                                <div class="media">
                                    <a href="#" class="pull-left">
                                        <img src="http://cdn.ibootstrap.cn/img/a_002.jpg" class="media-object"></a>
                    ...
                    <li class="nav-header">
                        ...
                        <div class="pull-right popover-info">
                            ...
                            <div class="popover fade right">
                                ...
                                <h3 class="popover-title">帮助</h3>
                                <div class="popover-content">
                                    拖放组件到布局容器. 拖入后, 你可以配置显示样式. 如果有任何疑问可访问
                                ...
                                <div class="accordion" id="myAccordion">
                                    <div class="accordion-group">
                                        <div class="accordion-heading">
                                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#myAccordion" href="#collapseOne" contenteditable="true">选项卡 #1</a>
                                        </div>
                                    ...
                                    <div class="accordion-group">
                                        <div class="accordion-heading">
                                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#myAccordion" href="#collapseTwo" contenteditable="true">选项卡 #2</a>
                                        </div>
                                ...
                                <div class="carousel slide" id="myCarousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="item active">
                                            <img alt="" src="http://cdn.ibootstrap.cn/v2/img/1.jpg">
                                        ...
                                        <div class="item">
                                            <img alt="" src="http://cdn.ibootstrap.cn/v2/img/2.jpg">
                                            <div class="carousel-caption" contenteditable="true">
                                                <h4>冲浪</h4>
                                                <p>
                                        ...
                                        <div class="item">
                                            <img alt="" src="http://cdn.ibootstrap.cn/v2/img/3.jpg">
                                            <div class="carousel-caption" contenteditable="true">
                                                <h4>自行车</h4>
                                                <p>
        ...
        <!--/span-->
        <div style="min-height: 401px;" class="demo ui-sortable"><div class="lyrow ui-draggable" style="display: block;">
                <a href="#close" class="remove label label-important">
                    <i class="icon-remove icon-white"></i>
                    删除
                </a>
                ...
                <div class="view">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="">
                        <a href="#" rel="text-success">成功</a>
                                ...
                                <div class="preview">标题栏</div>
                                <div class="view"><h3 class="text-left" contenteditable="true">资料补充${state}</h3>
                                </div>
                  ...
                  <a class="btn btn-mini" href="#" rel="lead">Lead</a>
                                ...
                                <div class="preview">段落</div>
                                <div class="view" contenteditable="true"><a href="/home/${action}" }="">返回</a></div>
                            </div></div>
                    </div>
                </div>
            </div></div>
